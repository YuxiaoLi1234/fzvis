...
ssh.exec_command('. /home/yli/lyx/spack/share/spack/setup-env.sh && spack load --sh   libpressio')


e,stdout,stderr = ssh.exec_command('. /home/yli/lyx/spack/share/spack/setup-env.sh && spack load --sh   libpressio')
