...
export default {
  ...
  methods:{
    ...
    draw:function(min,max,q1,q2,q3,colormap){
        // 假设这是你的100x100数组
...
const colormap1 = colormap.map((d)=>hexToRgb(d))
console.log(colormap1)
...
colormapSelect.addEventListener('change', () => {
    ...
    if (defaultColormaps[selectedColormap]) {
        ...
        this.draw(defaultColormaps[selectedColormap].split(', ').slice(1,-1))
    }
});
