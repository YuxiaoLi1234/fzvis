...
def indexlist():
    if request.method == 'POST':
        ...
        e,stdout,stderr = ssh.exec_command('. /home/yli/lyx/spack/share/spack/setup-env.sh && spack load libpressio && python3 /home/yli/lyx/getdata.py zfp "pressio:metric"="composite" "pressio:abs"=0.001')
