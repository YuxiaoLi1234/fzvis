...
const colorControlPoints = [
    { value: max*255, color: { r: colormap[0].r, g: colormap[0].g, b: colormap[0].b } },   // 蓝色
    { value: q3*255, color: { r: colormap[1].r, g: colormap[1].g, b: colormap[1].b } },  // 绿色
    { value: q2*255, color: { r: colormap[2].r, g: colormap[2].g, b: colormap[2].b } }, // 黄色
    { value: q1*255, color: { r: colormap[3].r, g: colormap[3].g, b: colormap[3].b } }, // 橙色
    { value: min*255, color: { r: colormap[4].r, g: colormap[4].g, b: colormap[4].b } },  // 红色s
];
...
function drawData(data) {
    ...
    for (let i = 0; i < colorData.length; i++) {
        for (let j = 0; j < colorData[i].length; j++) {
            ...
            that.context.fillStyle = `rgb(${color.r}, ${color.g}, ${color.b})`;
            that.context.fillRect(j, i, 1, 1);
        }
    }
}
drawData(data);
