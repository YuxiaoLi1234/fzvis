...
def indexlist():
    def comparing_compressor(arguments):
        ...
        print(input_data)
        print(type(eval(arguments["compressor_config"])))
        configs = {
                "compressor_id": arguments["compressor_id"],
                "early_config": eval(arguments["early_config"]),
                "compressor_config": eval(arguments["compressor_config"]),
                "bound":eval(arguments["compressor_config"])["pressio:abs"]
            }
        print('earlyconfig:',configs["early_config"])
    ...
    if request.method == 'POST':
        ...
        # print('读入的shihou',type(request.data['compressor_id']))
