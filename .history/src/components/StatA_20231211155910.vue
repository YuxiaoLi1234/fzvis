  ...
  export default {
    ...
    methods:{
        ...
        draw_parallel_c: function(data){
            ...
            let data1 = data.filter(item=>this.checked_c.includes(item.compressor_id) && data[0][item]!=null)
            ...
            let dimensions = Object.keys(data1[0]).filter(item=>item!='compressor_id' && typeof(data1[0][item])!='string')
