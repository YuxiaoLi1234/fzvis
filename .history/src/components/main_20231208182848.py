...
# 检查命令是否完成
print('dkanlk')
while not channel.recv_ready():  # 等待数据
    pass
...
def indexlist():
    if request.method == 'POST':
        ...
        # ssh.exec_command('. /home/yli/lyx/spack/share/spack/setup-env.sh && spack load libpressio && python3 /home/yli/lyx/getdata.py sz "pressio:metric"="composite" "pressio:abs"=0.001')
