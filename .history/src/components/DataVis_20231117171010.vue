<template>
    <div id="data_vis">
        <div id="dtcanvas">
            ...
            <canvas id="colorbarCanvas" width="400" height="40"></canvas>
        </div>
...
const colorControlPoints = [
    ...
    { value: min*255, color: { r: 255, g: 0, b: 0 } },  // 红色
...
const colorbarWidth = 300; // colorbar的宽度
const colorbarHeight = 50; // colorbar的高度
