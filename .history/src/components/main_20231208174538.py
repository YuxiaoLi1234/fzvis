...
e,stdout,stderr = ssh.exec_command('sudo /home/yli/lyx/spack/share/spack load libpressio')
# ssh.exec_command('python3 /home/yli/lyx/libpressio/test1/libpressio_tutorial/exercises/1_basics/python/list_compressors.py')
time.sleep(2)
channel = stdout.channel
sudo_prompt = channel.recv(1024).decode('utf-8')
if 'password' in sudo_prompt.lower():
    channel.send('30d5f21a21fca0cb18b8626f')
# 检查命令是否完成
