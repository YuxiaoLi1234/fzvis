  ...
  methods:{
    data_vis:function(){
        ...
        d3.json('./data/inputdata.json').then((d)=>{
            ...
            const q1 = calculatePercentile(that.input_data.flat(), 80);
            const q2 = calculatePercentile(that.input_data.flat(), 90);
            const q3 = calculatePercentile(that.input_data.flat(), 99);
...
const colorControlPoints = [
    { value: max, color: { r: 0, g: 0, b: 255 } },   // 蓝色
    { value: q3, color: { r: 0, g: 255, b: 0 } },  // 绿色
    { value: q2, color: { r: 255, g: 255, b: 0 } }, // 黄色
    { value: q1, color: { r: 255, g: 165, b: 0 } }, // 橙色
    { value: min, color: { r: 255, g: 0, b: 0 } },  // 红色
