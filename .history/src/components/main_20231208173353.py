...
ssh.exec_command('source /home/yli/lyx/spack/share/spack/setup-env.sh')

ssh.exec_command('spack load libpressio')
e,stdout,stderr = ssh.exec_command('bash -c "source /home/yli/lyx/spack/share/spack/setup-env.sh"')
